...
-- REMOVE apostrophe's from fields in temp_crimes2014
UPDATE temp_crimes2014
SET area_name = REPLACE(area_name,"'",'');

UPDATE temp_crimes2014
SET crime_desc = REPLACE(crime_desc,"'",'');

UPDATE temp_crimes2014
SET status_ = REPLACE(status_,"'",'');

UPDATE temp_crimes2014
SET status_desc = REPLACE(status_desc,"'",'');
